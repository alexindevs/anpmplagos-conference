    ...
    <>
      <header className="sticky top-0 z-10 border-b border-slate-200 bg-background-light/95 px-4 py-5 backdrop-blur dark:border-border-dark dark:bg-background-dark/95 sm:px-6 sm:py-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-black tracking-tight text-[#181112] dark:text-white">
              Hotel Bookings
            </h2>
                  ...
                  filtered.map((row) => {
                    ...
                    return (
                      <tr key={row.id} className="transition-colors hover:bg-primary/5 dark:hover:bg-background-dark-softer">
                        <td className="px-6 py-4 text-sm font-medium text-[#181112] dark:text-white/90">
                          {row.hotelName}
                        </td>
                        <td className="px-6 py-4 text-sm text-[#181112] dark:text-white/90">{row.roomType}</td>
                        <td className="px-6 py-4 text-sm text-[#181112] dark:text-white/90 whitespace-nowrap">
