...
const KIND_COLORS: Record<string, string> = {
  ...
  booth: "bg-teal-50 text-teal-700 border-teal-200",
  hotel_room: "bg-lime-50 text-lime-700 border-lime-200",
  sponsorship_plan: "bg-green-100 text-green-800 border-green-300",
  masterclass: "bg-emerald-100 text-emerald-800 border-emerald-300",
  panel: "bg-teal-100 text-teal-800 border-teal-300",
  presentation: "bg-teal-50 text-teal-600 border-teal-200",
  advert_slot: "bg-lime-100 text-lime-800 border-lime-300",
  branding_slot: "bg-emerald-50 text-emerald-600 border-emerald-100",
};
