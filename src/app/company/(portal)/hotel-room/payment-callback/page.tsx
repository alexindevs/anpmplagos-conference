...
/**
 * Canonical Paystack return URL for hotel-room payments (company path pattern).
 * Configure backend / Paystack: `/company/hotel-room/payment-callback?reference=...`
 */
function CompanyHotelRoomPaymentCallbackContent() {
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          ...
          <p className="text-center text-gray-600 mb-8">
            {isSuccess &&
              ...
              "Your hotel room slot is confirmed. Keep this reference for your records."}
...
export default function CompanyHotelRoomPaymentCallbackPage() {
  return (
    <Suspense fallback={<PaymentCallbackSuspenseFallback />}>
      <CompanyHotelRoomPaymentCallbackContent />
    </Suspense>
  );
}
