  ...
  return (
    <main className="flex-1 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mb-6 border-l-4 border-secondary pl-4">
        <h1 className="text-2xl font-black text-[#181112]">Company Conference Ticket</h1>
                ...
                <div className="border-t border-slate-200 pt-6">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full flex items-center justify-between gap-4 p-4 bg-gradient-to-r from-secondary to-medical-green text-white font-bold shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
