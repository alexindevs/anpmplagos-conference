        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-start gap-3">
              <button
                ...
                className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-bold text-charcoal transition-colors hover:border-secondary hover:text-secondary"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full max-w-[120px] rounded-lg border border-slate-300 px-3 py-2 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none"
            />
